        ...
        try {
            ...
            if (res ?. status === "failed") {
                ...
                if (isRegister) {
                    ...
                    const redirectPath = accountType === "seeker" ? '/find-projects' : '/projects';
                            ...
                            <Transition.Child as={Fragment}
                                ...
                                <Dialog.Panel className='w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all '>
                                    ...
                                    <div className='w-full flex items-center justify-center py-4 '>
                                        <button className={
                                                `flex-1 px-4 py-2 rounded text-sm outline-none ${
                                        ...
                                        <button className={
                                                `flex-2 px-4 py-2 rounded text-sm outline-none ${
                                                    accountType !== "seeker" ? "bg-[#1d4fd862] text-blue-900 font-semibold" : "bg-white border border-blue-400"
                                                }`
                                            }
                                            onClick={
                                    ...
                                    <form className='w-full flex flex-col gap-5'
                                            ...
                                            <div className='w-full flex gap-1 md:gap-2'>
                                                <div className={
                                                    ...
                                                    <TextInput name={
                                                        ...
                                                        placeholder={
                                                            accountType === "seeker" ? "eg. James" : "Comapy name"
                                                        }
                                                        type='text'
                                                        register={
                                                        ...
                                                        error={
                                                            accountType === "seeker" ? errors.firstName ? errors.firstName ?. message : "" : errors.name ? errors.name ?. message : ""
                                                        }/>
                                                </div>
                                        ...
                                        isRegister && accountType === "seeker" && (
                                            <div className="w-full">
                                                <TextInput name="studentID" label="Student ID" placeholder="Enter your student ID" type="text"
                                                    register={
                                    ...
                                    <div className='mt-4'>
                                        <p className='text-sm text-gray-700'>
                                            ...
                                            <span className='text-sm text-blue-600 ml-2 hover:text-blue-700 hover:font-semibold cursor-pointer'
                                                onClick={
