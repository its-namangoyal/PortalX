      ...
      <div className='relative bg-[#f7fdfd] z-50'>
        <nav className='container mx-auto flex items-center justify-between p-5'>
          <div>
            ...
            </Link> : <Link className='text-blue-600 font-bold text-xl'>
              Portal<span className='text-[#1677cccb]'>X</span>
            </Link>
            }
          </div>
          ...
          <ul className='hidden lg:flex gap-10 text-base'>
            <li>
              <Link to='/'>{user?.accountType === "seeker" ? "Find Internships" : ""}</Link>
            </li>
            <li>
              <Link to='/companies'>{user?.accountType === "seeker" ? "Companies / Professors" : ""}</Link>
            </li>

            {(user?.accountType !== "seeker" && user?.email) ? <li>
        ...
        >
          ...
          <Link
            ...
            to={
              user?.accountType === "seeker" ? "applly-gistory" : "upload-project"
            }
          >
